...
export const translations = {
  en: {
   ...
   continueToApp: 'Continue',
    ...
    completedRoutine: 'I completed my routine today ✓',
    routineCompleted: 'Routine completed!',
    routineCompletedDesc: 'Amazing! You earned +5 points 🎉',
    alreadyCompleted: 'Already completed today ✨',
    routineDoneToday: 'Done for today ✨',
    comeBackTomorrow: 'Come back tomorrow to keep your streak!',
    yourProgress: 'Your Progress',
    skinImproving: 'You\'re building consistency',
    hydrationLevel: 'Hydration focus',
    consistencyScore: 'Routine consistency',
    todayRecommendations: 'Today\'s Picks for You',
    becauseSkinDry: 'Because your skin needs hydration',
    becauseSkinOily: 'Because your skin is oily',
    becauseSkinAcne: 'Because you\'re fighting breakouts',
    becauseSkinSensitive: 'Because your skin is sensitive',
    becauseHairDry: 'Because your hair needs moisture',
    becauseHairFrizz: 'Because you want to tame frizz',
    becauseNatural: 'Because you love natural remedies',
    naturalRemedy: 'Natural Remedy',
    skinNeedsHydration: 'Your skin needs extra hydration today',
    skinLooksGreat: 'Your skin is looking great! Keep going',
    hairNeedsCare: 'Time for some hair love today',
    keepUpStreak: 'Don\'t break your streak!',
    startYourJourney: 'Start your beauty journey today',
    daysStreak: 'days',
    ...
    selectedForYourProfile: 'Selected for your profile',
    curatedForYou: 'Matched to your skin & hair needs',
    ...
    reasonAllNatural: 'Prioritizes gentle formulas',
    ...
    resetEmailSentDesc: "If an account exists for {email}, we've sent a password reset link. Check your inbox (and spam folder).",
    backToLogin: 'Back to login',
    invalidLinkTitle: 'Invalid or expired link',
    invalidLinkDesc: 'This password reset link has expired or is invalid. Please request a new one.',
    requestNewLink: 'Request new link',
    passwordUpdatedTitle: 'Password updated!',
    passwordUpdatedDesc: 'Redirecting you to the app…',
   ...
   postUnderReviewToast: 'Your post is under review and will be visible once approved 🔍',
   ...
   editProfileSetting: 'Edit Profile',
   languageSetting: 'Language',
   notificationsSetting: 'Notifications',
   privacySetting: 'Privacy',
   rewardsSetting: 'Rewards',
   settings: 'Settings',
    unsavePost: 'Saved',
    followUser: 'Follow',
    ...
    // Ingredient notes
    ingNoteReducesBlemishes: 'Reduces blemishes',
    ingNoteOilControl: 'Oil control',
    ingNoteReducesIrritation: 'Reduces irritation',
    ingNoteBondRepair: 'Bond repair',
    ingNoteShineEnhancement: 'Shine enhancement',
    ingNoteAntioxidant: 'Antioxidant',
    ingNoteRestoresBarrier: 'Restores skin barrier',
    ingNoteHydration: 'Hydration',
    ingNoteMoistureRetention: 'Moisture retention',
    ingNoteShineSoftness: 'Shine & softness',
    ingNoteNourishment: 'Nourishment',
    ingNoteConditioning: 'Conditioning',
    ingNoteLightMoisture: 'Lightweight moisture',
    ingNoteDeepConditioning: 'Deep conditioning',
    ingNoteStrengthening: 'Strengthening',
    ingNoteShineProtection: 'Shine & protection',
    ingNoteDeepNourishment: 'Deep nourishment',
    ingNoteProtectiveBarrier: 'Protective barrier',
    ingNoteSoothesCalms: 'Soothes & calms',
    ingNoteAntiInflammatory: 'Anti-inflammatory',
    ingNoteSkinRepair: 'Skin repair',
    ingNoteVitaminAC: 'Rich in Vitamin A & C',
    ingNoteSkinRegeneration: 'Skin regeneration',
    ingNoteAntioxidantProtection: 'Antioxidant protection',
    ingNoteGentleExfoliation: 'Gentle exfoliation',
    ingNotePoreRefinement: 'Pore refinement',
    ingNoteBrighteningAntiRedness: 'Brightening & anti-redness',
    ingNoteIntenseNourishment: 'Intense nourishment',
    ingNoteSofteningRepair: 'Softening & repair',
  ...
  es: {
   ...
   continueToApp: 'Continuar',
    ...
    completedRoutine: 'Completé mi rutina hoy ✓',
    routineCompleted: '¡Rutina completada!',
    routineCompletedDesc: '¡Increíble! Ganaste +5 puntos 🎉',
    alreadyCompleted: 'Ya completada hoy ✨',
    routineDoneToday: 'Listo por hoy ✨',
    comeBackTomorrow: '¡Vuelve mañana para mantener tu racha!',
    yourProgress: 'Tu progreso',
    skinImproving: 'Estás creando constancia',
    hydrationLevel: 'Enfoque en hidratación',
    consistencyScore: 'Constancia de rutina',
    todayRecommendations: 'Selección de hoy para ti',
    becauseSkinDry: 'Porque tu piel necesita hidratación',
    becauseSkinOily: 'Porque tu piel es grasa',
    becauseSkinAcne: 'Porque estás combatiendo el acné',
    becauseSkinSensitive: 'Porque tu piel es sensible',
    becauseHairDry: 'Porque tu cabello necesita hidratación',
    becauseHairFrizz: 'Porque quieres controlar el frizz',
    becauseNatural: 'Porque amas los remedios naturales',
    naturalRemedy: 'Remedio natural',
    skinNeedsHydration: 'Tu piel necesita hidratación extra hoy',
    skinLooksGreat: '¡Tu piel se ve genial! Sigue así',
    hairNeedsCare: 'Es momento de cuidar tu cabello hoy',
    keepUpStreak: '¡No pierdas tu racha!',
    startYourJourney: 'Comienza tu viaje de belleza hoy',
    daysStreak: 'días',
    ...
    selectedForYourProfile: 'Seleccionado para tu perfil',
    curatedForYou: 'Adaptado a las necesidades de tu piel y cabello',
    ...
    reasonAllNatural: 'Prioriza fórmulas suaves',
    ...
    loginSignInDesc: 'Inicia sesión para continuar',
    ...
    loginDontHaveAccount: '¿No tienes cuenta?',
    loginSignIn: 'Entrar',
    ...
    resetEmailSentDesc: 'Si existe una cuenta para {email}, te hemos enviado un enlace de restablecimiento. Revisa tu bandeja (y spam).',
    backToLogin: 'Volver al inicio de sesión',
    invalidLinkTitle: 'Enlace inválido o caducado',
    invalidLinkDesc: 'Este enlace de restablecimiento ha caducado o es inválido. Solicita uno nuevo.',
    requestNewLink: 'Solicitar nuevo enlace',
    passwordUpdatedTitle: '¡Contraseña actualizada!',
    passwordUpdatedDesc: 'Redirigiéndote a la app…',
    setNewPasswordTitle: 'Nueva contraseña',
    setNewPasswordDesc: 'Elige una contraseña segura para tu cuenta.',
    newPassword: 'Nueva contraseña',
    confirmPasswordLabel: 'Confirmar contraseña',
    reenterPassword: 'Repite la contraseña',
   ...
   deletePostDesc: 'Esta acción no se puede deshacer. Se eliminará tu publicación y todos sus comentarios.',
   ...
   postUnderReviewToast: 'Tu publicación está en revisión y será visible una vez aprobada 🔍',
   failedCreatePost: 'Error al crear la publicación',
   failedUpdatePost: 'Error al actualizar la publicación',
   failedDeletePost: 'Error al eliminar la publicación',
   failedAddComment: 'Error al añadir el comentario',
   failedDeleteComment: 'Error al eliminar el comentario',
   postTooLong: 'La publicación debe tener {max} caracteres o menos',
   commentTooLong: 'El comentario debe tener {max} caracteres o menos',
   ...
   deleteAdmin: 'Eliminar (Admin)',
   editProfileSetting: 'Editar perfil',
   languageSetting: 'Idioma',
   notificationsSetting: 'Notificaciones',
   privacySetting: 'Privacidad',
   rewardsSetting: 'Recompensas',
   settings: 'Ajustes',
    unsavePost: 'Guardado',
    followUser: 'Seguir',
    ...
    // Ingredient notes
    ingNoteReducesBlemishes: 'Reduce imperfecciones',
    ingNoteOilControl: 'Control de grasa',
    ingNoteReducesIrritation: 'Reduce la irritación',
    ingNoteBondRepair: 'Reparación de enlaces',
    ingNoteShineEnhancement: 'Mejora el brillo',
    ingNoteAntioxidant: 'Antioxidante',
    ingNoteRestoresBarrier: 'Restaura la barrera cutánea',
    ingNoteHydration: 'Hidratación',
    ingNoteMoistureRetention: 'Retención de humedad',
    ingNoteShineSoftness: 'Brillo y suavidad',
    ingNoteNourishment: 'Nutrición',
    ingNoteConditioning: 'Acondicionamiento',
    ingNoteLightMoisture: 'Hidratación ligera',
    ingNoteDeepConditioning: 'Acondicionamiento profundo',
    ingNoteStrengthening: 'Fortalecimiento',
    ingNoteShineProtection: 'Brillo y protección',
    ingNoteDeepNourishment: 'Nutrición profunda',
    ingNoteProtectiveBarrier: 'Barrera protectora',
    ingNoteSoothesCalms: 'Calma y suaviza',
    ingNoteAntiInflammatory: 'Antiinflamatorio',
    ingNoteSkinRepair: 'Reparación de la piel',
    ingNoteVitaminAC: 'Rico en vitamina A y C',
    ingNoteSkinRegeneration: 'Regeneración de la piel',
    ingNoteAntioxidantProtection: 'Protección antioxidante',
    ingNoteGentleExfoliation: 'Exfoliación suave',
    ingNotePoreRefinement: 'Refinamiento de poros',
    ingNoteBrighteningAntiRedness: 'Luminosidad y anti-rojeces',
    ingNoteIntenseNourishment: 'Nutrición intensa',
    ingNoteSofteningRepair: 'Suaviza y repara',
  ...
  fr: {
   ...
   continueToApp: 'Continuer',
    ...
    completedRoutine: 'J\'ai terminé ma routine aujourd\'hui ✓',
    routineCompleted: 'Routine terminée !',
    routineCompletedDesc: 'Incroyable ! Vous avez gagné +5 points 🎉',
    alreadyCompleted: 'Déjà terminée aujourd\'hui ✨',
    routineDoneToday: 'Terminé pour aujourd\'hui ✨',
    comeBackTomorrow: 'Revenez demain pour garder votre série !',
    yourProgress: 'Vos progrès',
    skinImproving: 'Vous construisez une routine',
    hydrationLevel: 'Focus hydratation',
    consistencyScore: 'Régularité de routine',
    todayRecommendations: 'Sélection du jour pour vous',
    becauseSkinDry: 'Parce que votre peau a besoin d\'hydratation',
    becauseSkinOily: 'Parce que votre peau est grasse',
    becauseSkinAcne: 'Parce que vous combattez les imperfections',
    becauseSkinSensitive: 'Parce que votre peau est sensible',
    becauseHairDry: 'Parce que vos cheveux ont besoin d\'hydratation',
    becauseHairFrizz: 'Parce que vous voulez dompter les frisottis',
    becauseNatural: 'Parce que vous aimez les remèdes naturels',
    naturalRemedy: 'Remède naturel',
    skinNeedsHydration: 'Votre peau a besoin d\'hydratation supplémentaire aujourd\'hui',
    skinLooksGreat: 'Votre peau est superbe ! Continuez',
    hairNeedsCare: 'C\'est le moment de prendre soin de vos cheveux',
    keepUpStreak: 'Ne perdez pas votre série !',
    startYourJourney: 'Commencez votre voyage beauté aujourd\'hui',
    daysStreak: 'jours',
    ...
    selectedForYourProfile: 'Sélectionné pour votre profil',
    curatedForYou: 'Adapté aux besoins de votre peau et cheveux',
    ...
    reasonAllNatural: 'Privilégie les formules douces',
    ...
    resetEmailSentDesc: "Si un compte existe pour {email}, nous avons envoyé un lien de réinitialisation. Vérifiez votre boîte (et spam).",
    backToLogin: 'Retour à la connexion',
    invalidLinkTitle: 'Lien invalide ou expiré',
    invalidLinkDesc: 'Ce lien de réinitialisation a expiré ou est invalide. Veuillez en demander un nouveau.',
    requestNewLink: 'Demander un nouveau lien',
    passwordUpdatedTitle: 'Mot de passe mis à jour !',
    passwordUpdatedDesc: 'Redirection vers l\'app…',
   ...
   deletePostConfirm: 'Supprimer la publication ?',
   deletePostDesc: 'Cette action est irréversible. Votre publication et tous ses commentaires seront supprimés.',
   ...
   postUnderReviewToast: 'Votre publication est en cours de révision et sera visible une fois approuvée 🔍',
   failedCreatePost: 'Échec de la création',
   failedUpdatePost: 'Échec de la mise à jour',
   failedDeletePost: 'Échec de la suppression',
   failedAddComment: 'Échec de l\'ajout du commentaire',
   failedDeleteComment: 'Échec de la suppression du commentaire',
   postTooLong: 'La publication doit contenir {max} caractères ou moins',
   commentTooLong: 'Le commentaire doit contenir {max} caractères ou moins',
   ...
   deleteAdmin: 'Supprimer (Admin)',
   editProfileSetting: 'Modifier le profil',
   languageSetting: 'Langue',
   notificationsSetting: 'Notifications',
   privacySetting: 'Confidentialité',
   rewardsSetting: 'Récompenses',
   settings: 'Paramètres',
    ...
    // Ingredient notes
    ingNoteReducesBlemishes: 'Réduit les imperfections',
    ingNoteOilControl: 'Contrôle du sébum',
    ingNoteReducesIrritation: 'Réduit l\'irritation',
    ingNoteBondRepair: 'Réparation des liens',
    ingNoteShineEnhancement: 'Améliore la brillance',
    ingNoteAntioxidant: 'Antioxydant',
    ingNoteRestoresBarrier: 'Restaure la barrière cutanée',
    ingNoteHydration: 'Hydratation',
    ingNoteMoistureRetention: 'Rétention d\'hydratation',
    ingNoteShineSoftness: 'Brillance et douceur',
    ingNoteNourishment: 'Nutrition',
    ingNoteConditioning: 'Soin',
    ingNoteLightMoisture: 'Hydratation légère',
    ingNoteDeepConditioning: 'Soin profond',
    ingNoteStrengthening: 'Renforcement',
    ingNoteShineProtection: 'Brillance et protection',
    ingNoteDeepNourishment: 'Nutrition profonde',
    ingNoteProtectiveBarrier: 'Barrière protectrice',
    ingNoteSoothesCalms: 'Apaise et calme',
    ingNoteAntiInflammatory: 'Anti-inflammatoire',
    ingNoteSkinRepair: 'Réparation de la peau',
    ingNoteVitaminAC: 'Riche en vitamines A et C',
    ingNoteSkinRegeneration: 'Régénération de la peau',
    ingNoteAntioxidantProtection: 'Protection antioxydante',
    ingNoteGentleExfoliation: 'Exfoliation douce',
    ingNotePoreRefinement: 'Affinement des pores',
    ingNoteBrighteningAntiRedness: 'Éclat et anti-rougeurs',
    ingNoteIntenseNourishment: 'Nutrition intense',
    ingNoteSofteningRepair: 'Adoucit et répare',
