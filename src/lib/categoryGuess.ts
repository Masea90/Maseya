...
const FOOD_MAP: Array<[string[], string[]]> = [
  ...
  [['pan', 'bread'], ['en:breads']],
  [['mayonesa', 'mayonnaise'], ['en:mayonnaises', 'en:sauces']],
  [['queso', 'cheese'], ['en:cheeses', 'en:dairies']],
  [['mantequilla', 'butter'], ['en:butters', 'en:dairies']],
  [['cerveza', 'beer'], ['en:beers', 'en:alcoholic-beverages']],
  [['patatas fritas', 'papas fritas', 'chips', 'crisps'], ['en:crisps', 'en:chips']],
  [['refresco', 'soda', 'cola', 'gaseosa'], ['en:sodas', 'en:carbonated-drinks']],
  [['atun', 'atún', 'tuna'], ['en:tunas', 'en:canned-fish']],
  [['jamon', 'jamón', 'ham'], ['en:hams', 'en:charcuteries']],
  [['pizza'], ['en:pizzas']],
  [['helado', 'ice cream', 'ice-cream'], ['en:ice-creams', 'en:frozen-desserts']],
