...
export const productCatalog: Product[] = [
  ...
  },
  {
    ...
    image: paiRosehip,
    category: 'skin',
    tags: ['vegan', 'organic', 'cruelty-free'],
    targetConcerns: ['dryness', 'aging', 'dullness', 'hyperpigmentation'],
    targetHairTypes: [],
  ...
  },
  {
    ...
    image: renSerum,
    category: 'skin',
    tags: ['vegan', 'cruelty-free', 'natural'],
    targetConcerns: ['dullness', 'pores', 'oiliness'],
    targetHairTypes: [],
    targetGoals: ['clearskin'],
